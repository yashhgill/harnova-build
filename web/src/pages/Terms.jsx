...
const SECTIONS = [
  ['The service', 'HarNova Build hosts a static website you provide, on a harnova.my subdomain, for 30 days per RM10 payment. Activation happens after we manually verify your DuitNow transfer — usually within a few hours, always the same day. Your site stays saved as a draft until then.'],
